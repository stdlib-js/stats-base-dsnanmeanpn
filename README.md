...
```javascript
dsnanmeanpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dsnanmeanpn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dsnanmeanpn/tags). For example,

```javascript
dsnanmeanpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dsnanmeanpn@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dsnanmeanpn = require( 'path/to/vendor/umd/stats-base-dsnanmeanpn/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/actions/workflows/test.yml?query=branch:v0.2.1
...
[deno-readme]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-dsnanmeanpn/blob/esm/README.md
